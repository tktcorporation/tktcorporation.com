(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[888],{3454:function(e,t,n){"use strict";var r,a;e.exports=(null==(r=n.g.process)?void 0:r.env)&&"object"==typeof(null==(a=n.g.process)?void 0:a.env)?n.g.process:n(7663)},6840:function(e,t,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/_app",function(){return n(7311)}])},7311:function(e,t,n){"use strict";let r,a,i,o,s,l,c,u,h;n.r(t),n.d(t,{default:function(){return tG}});var d,f,p,g,m=n(5893);n(7375);var b=n(7294),w=n(3454);/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tD="installations";ew(new H(tD,e=>{let t=e.getProvider("app").getImmediate(),n=/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tA(e){if(!e.startsWith(tS)){let t=tT.create("invalid-gtag-resource",{gtagURL:e});return tC.warn(t.message),""}return e}function tB(e){return Promise.all(e.map(e=>e.catch(e=>e)))}async function tL(e,t,n,r,a,i){let o=r[a];try{if(o)await t[o];else{let e=await tB(n),r=e.find(e=>e.measurementId===a);r&&await t[r.appId]}}catch(e){tC.error(e)}e("config",a,i)}async function tO(e,t,n,r,a){try{let i=[];if(a&&a.send_to){let e=a.send_to;Array.isArray(e)||(e=[e]);let r=await tB(n);for(let n of e){let e=r.find(e=>e.measurementId===n),a=e&&t[e.appId];if(a)i.push(a);else{i=[];break}}}0===i.length&&(i=Object.values(t)),await Promise.all(i),e("event",r,a||{})}catch(e){tC.error(e)}}let tk=new class{constructor(e={},t=1e3){this.throttleMetadata=e,this.intervalMillis=t}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,t){this.throttleMetadata[e]=t}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}};async function tM(e){var t;let{appId:n,apiKey:r}=e,a={method:"GET",headers:new Headers({Accept:"application/json","x-goog-api-key":r})},i="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig".replace("{app-id}",n),o=await fetch(i,a);if(200!==o.status&&304!==o.status){let e="";try{let n=await o.json();(null===(t=n.error)||void 0===t?void 0:t.message)&&(e=n.error.message)}catch(e){}throw tT.create("config-fetch-failed",{httpStatus:o.status,responseMessage:e})}return o.json()}async function tj(e,t=tk,n){let{appId:r,apiKey:a,measurementId:i}=e.options;if(!r)throw tT.create("no-app-id");if(!a){if(i)return{measurementId:i,appId:r};throw tT.create("no-api-key")}let o=t.getThrottleMetadata(r)||{backoffCount:0,throttleEndTimeMillis:Date.now()},s=new t$;return setTimeout(async()=>{s.abort()},void 0!==n?n:6e4),tN({appId:r,apiKey:a,measurementId:i},o,s,t)}async function tN(e,{throttleEndTimeMillis:t,backoffCount:n},r,a=tk){var i;let{appId:o,measurementId:s}=e;try{await new Promise((e,n)=>{let a=Math.max(t-Date.now(),0),i=setTimeout(e,a);r.addEventListener(()=>{clearTimeout(i),n(tT.create("fetch-throttle",{throttleEndTimeMillis:t}))})})}catch(e){if(s)return tC.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${s} provided in the "measurementId" field in the local Firebase config. [${null==e?void 0:e.message}]`),{appId:o,measurementId:s};throw e}try{let t=await tM(e);return a.deleteThrottleMetadata(o),t}catch(c){if(!function(e){if(!(e instanceof j)||!e.customData)return!1;let t=Number(e.customData.httpStatus);return 429===t||500===t||503===t||504===t}(c)){if(a.deleteThrottleMetadata(o),s)return tC.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${s} provided in the "measurementId" field in the local Firebase config. [${null==c?void 0:c.message}]`),{appId:o,measurementId:s};throw c}let t=503===Number(null===(i=null==c?void 0:c.customData)||void 0===i?void 0:i.httpStatus)?F(n,a.intervalMillis,30):F(n,a.intervalMillis),l={throttleEndTimeMillis:Date.now()+t,backoffCount:n+1};return a.setThrottleMetadata(o,l),tC.debug(`Calling attemptFetch again in ${t} millis`),tN(e,l,r,a)}}class t${constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function tP(e,t,n,r,a){if(a&&a.global){e("event",n,r);return}{let a=await t,i=Object.assign(Object.assign({},r),{send_to:a});e("event",n,i)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tx(){if(!k())return tC.warn(tT.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;try{await M()}catch(e){return tC.warn(tT.create("indexeddb-unavailable",{errorInfo:null==e?void 0:e.toString()}).message),!1}return!0}async function tF(e,t,n,r,a,i,o){var c;let u=tj(e);u.then(t=>{n[t.measurementId]=t.appId,e.options.measurementId&&t.measurementId!==e.options.measurementId&&tC.warn(`The measurement ID in the local Firebase config (${e.options.measurementId}) does not match the measurement ID fetched from the server (${t.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(e=>tC.error(e)),t.push(u);let h=tx().then(e=>e?r.getId():void 0),[d,f]=await Promise.all([u,h]);!function(e){let t=window.document.getElementsByTagName("script");for(let n of Object.values(t))if(n.src&&n.src.includes(tS)&&n.src.includes(e))return n;return null}(i)&&function(e,t){let n;let r=(window.trustedTypes&&(n=window.trustedTypes.createPolicy("firebase-js-sdk-policy",{createScriptURL:tA})),n),a=document.createElement("script"),i=`${tS}?l=${e}&id=${t}`;a.src=r?null==r?void 0:r.createScriptURL(i):i,a.async=!0,document.head.appendChild(a)}(i,d.measurementId),l&&(a("consent","default",l),l=void 0),a("js",new Date);let p=null!==(c=null==o?void 0:o.config)&&void 0!==c?c:{};return p.origin="firebase",p.update=!0,null!=f&&(p.firebase_id=f),a("config",d.measurementId,p),s&&(a("set",s),s=void 0),d.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tR{constructor(e){this.app=e}_delete(){return delete tH[this.app.options.appId],Promise.resolve()}}let tH={},tz=[],tV={},tW="dataLayer",tU=!1,tq="@firebase/analytics",tK="0.10.0";ew(new H(t_,(e,{options:t})=>{let n=e.getProvider("app").getImmediate(),r=e.getProvider("installations-internal").getImmediate();return function(e,t,n){!function(){let e=[];if(function(){let e="object"==typeof chrome?chrome.runtime:"object"==typeof browser?browser.runtime:void 0;return"object"==typeof e&&void 0!==e.id}()&&e.push("This is a browser extension environment."),"undefined"!=typeof navigator&&navigator.cookieEnabled||e.push("Cookies are not available."),e.length>0){let t=e.map((e,t)=>`(${t+1}) ${e}`).join(" "),n=tT.create("invalid-analytics-context",{errorInfo:t});tC.warn(n.message)}}();let r=e.options.appId;if(!r)throw tT.create("no-app-id");if(!e.options.apiKey){if(e.options.measurementId)tC.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw tT.create("no-api-key")}if(null!=tH[r])throw tT.create("already-exists",{id:r});if(!tU){var a,i;let e,t;e=[],Array.isArray(window[tW])?e=window[tW]:window[tW]=e;let{wrappedGtag:n,gtagCore:r}=(a="gtag",t=function(...e){window[tW].push(arguments)},window[a]&&"function"==typeof window[a]&&(t=window[a]),window[a]=(i=t,async function(e,...t){try{if("event"===e){let[e,n]=t;await tO(i,tH,tz,e,n)}else if("config"===e){let[e,n]=t;await tL(i,tH,tz,tV,e,n)}else if("consent"===e){let[e]=t;i("consent","update",e)}else if("get"===e){let[e,n,r]=t;i("get",e,n,r)}else if("set"===e){let[e]=t;i("set",e)}else i(e,...t)}catch(e){tC.error(e)}}),{gtagCore:t,wrappedGtag:window[a]});u=n,c=r,tU=!0}tH[r]=tF(e,tz,tV,t,c,tW,n);let o=new tR(e);return o}(n,r,t)},"PUBLIC")),ew(new H("analytics-internal",function(e){try{let t=e.getProvider(t_).getImmediate();return{logEvent:(e,n,r)=>{var a;return a=t,void(a=R(a),tP(u,tH[a.app.options.appId],e,n,r).catch(e=>tC.error(e)))}}}catch(e){throw tT.create("interop-component-reg-failed",{reason:e})}},"PRIVATE")),eD(tq,tK),eD(tq,tK,"esm2017"),Array.from(em.values()).length||(eE({apiKey:"AIzaSyDCMz60fSZWmUamvWoiCm3qnMwWnqo0Ld8",authDomain:"tktcorporation-home.firebaseapp.com",databaseURL:"https://tktcorporation-home.firebaseio.com",projectId:"tktcorporation-home",storageBucket:"tktcorporation-home.appspot.com",messagingSenderId:"30824290023",appId:"1:30824290023:web:45dde016c25c8560a83442",measurementId:"G-JLL4WBFC4D"}),h=function(e=function(e=ep){let t=em.get(e);if(!t&&e===ep&&L())return eE();if(!t)throw ev.create("no-app",{appName:e});return t}()){e=R(e);let t=ey(e,t_);return t.isInitialized()?t.getImmediate():function(e,t={}){let n=ey(e,t_);if(n.isInitialized()){let e=n.getImmediate();if(P(t,n.getOptions()))return e;throw tT.create("already-initialized")}let r=n.initialize({options:t});return r}(e)}());var tG=function(e){let{Component:t,pageProps:n}=e;return(0,b.useEffect)(()=>{h.app.automaticDataCollectionEnabled=!0},[]),(0,m.jsx)(t,{...n})}},7375:function(){},7663:function(e){!function(){var t={229:function(e){var t,n,r,a=e.exports={};function i(){throw Error("setTimeout has not been defined")}function o(){throw Error("clearTimeout has not been defined")}function s(e){if(t===setTimeout)return setTimeout(e,0);if((t===i||!t)&&setTimeout)return t=setTimeout,setTimeout(e,0);try{return t(e,0)}catch(n){try{return t.call(null,e,0)}catch(n){return t.call(this,e,0)}}}!function(){try{t="function"==typeof setTimeout?setTimeout:i}catch(e){t=i}try{n="function"==typeof clearTimeout?clearTimeout:o}catch(e){n=o}}();var l=[],c=!1,u=-1;function h(){c&&r&&(c=!1,r.length?l=r.concat(l):u=-1,l.length&&d())}function d(){if(!c){var e=s(h);c=!0;for(var t=l.length;t;){for(r=l,l=[];++u<t;)r&&r[u].run();u=-1,t=l.length}r=null,c=!1,function(e){if(n===clearTimeout)return clearTimeout(e);if((n===o||!n)&&clearTimeout)return n=clearTimeout,clearTimeout(e);try{n(e)}catch(t){try{return n.call(null,e)}catch(t){return n.call(this,e)}}}(e)}}function f(e,t){this.fun=e,this.array=t}function p(){}a.nextTick=function(e){var t=Array(arguments.length-1);if(arguments.length>1)for(var n=1;n<arguments.length;n++)t[n-1]=arguments[n];l.push(new f(e,t)),1!==l.length||c||s(d)},f.prototype.run=function(){this.fun.apply(null,this.array)},a.title="browser",a.browser=!0,a.env={},a.argv=[],a.version="",a.versions={},a.on=p,a.addListener=p,a.once=p,a.off=p,a.removeListener=p,a.removeAllListeners=p,a.emit=p,a.prependListener=p,a.prependOnceListener=p,a.listeners=function(e){return[]},a.binding=function(e){throw Error("process.binding is not supported")},a.cwd=function(){return"/"},a.chdir=function(e){throw Error("process.chdir is not supported")},a.umask=function(){return 0}}},n={};function r(e){var a=n[e];if(void 0!==a)return a.exports;var i=n[e]={exports:{}},o=!0;try{t[e](i,i.exports,r),o=!1}finally{o&&delete n[e]}return i.exports}r.ab="//";var a=r(229);e.exports=a}()}},function(e){var t=function(t){return e(e.s=t)};e.O(0,[774,179],function(){return t(6840),t(8355)}),_N_E=e.O()}]);